...
<html lang="en">
  ...
  <body> 
    ...
    <?php if(isset( $_GET['error'])): ?>
            <p align='center'> <b class="error"><?php 
                echo $_GET['error'];
                 ?></b>
            </p>
            <?php endif ?>
      ...
      <div>
          <span class="product-price font-bold">Amount</span>
          
      </div>
      <div class="font-bold">
      <span class="product-price font-bold">Action</span>
      </div> 
    </div>
    <hr>
    <!-- table end -->
...
cart_info ON product_info.product_id=cart_info.Product_id WHERE cart_info.user_id=$id";
...
while ($row1 = mysqli_fetch_array($result)) {
 ...
 <div class="grid" id="product-listing" ><div ><img class="product-img" src="product_image/<?=$img;?>" alt="product"/></div>
 ...
 <div>
   <label for="qty-input"><?php echo $quantity; ?></label>
 </div>
 <div>
   
   <span class="product-price"><?php echo $pprice*$quantity; ?></span>
 </div>
 
 <div>
   
   <button type="button" >
   <a class="delete-btn" href="<?php echo"delete_cart_product.php?id=" .$id."&pid=" .$pid;?>">Delete </a>
    </button>
   <button type="button" >
      <a class="delete-btn" href="<?php echo"updateQty.php?id=" .$id."&pid=" .$pid;?>">Update Qty</a>
    </button>
...
<!-- table end -->
<div ><button type="button" class="final-checkout-btn" ><a class="delete-btn" href="<?php echo"order.php?id=" .$id."&pid=" .$pid;?>">checkout</a></button></div>
 </div>
