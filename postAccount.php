  ...
  <header>
    ...
    <div class="form-modal">
      ...
      <?php if(isset( $_GET['error'])): ?>
            ...
            <?php endif ?>
        <form action="postLogin.php?id=<?php echo $_GET['id'];?>" method="post">
          <input class="input" type="text" placeholder="Your username" name ="lusername"/>
          <div class="select">
            <select name="ltype">
          ...
          <input class="input" type="password" placeholder="Enter password"  name ="lpassword"/>
          <button type="submit"name="lsubmit" class="btn login">login</button>
        </form>
      </div>

      <div id="signup-form">
      
        <form action="postregister.php?id=<?php echo $_GET['id'];?>"
    method ="post">
          <input class="input" type="email" placeholder="Enter your email" name="email" />
          <input  class="input" type="text" placeholder="Choose username" name="username" />
          <div class="select">
